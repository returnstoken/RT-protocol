...
import './ReturnsToken.sol';
import './GovernorService.sol';

/**
 * @title  On-chain GovernorService implementation for approving trades
 * @author Bob Remeika
 */
contract TokenGovernorService is GovernorService, Ownable {
  /**
  ...
  function TokenGovernorService() public {
    admin = msg.sender;
  }
  ...
  /**
   * @notice Retrieves the whole token value from a token that this `GovernorService` manages
   *

...
/// @notice A service that points to a `GovernorService`
contract ServiceRegistry is Ownable {
   ...
   * @notice Constructor
   *
   * @param _service The address of the `GovernorService`
   *
   */
  ...
  /**
   * @notice Replaces the address pointer to the `GovernorService`
   *
   * @dev This method is only callable by the contract's owner
   *
   * @param _service The address of the new `Governor
   Service`
   */

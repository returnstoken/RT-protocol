...
const ServiceRegistry = artifacts.require('./ServiceRecorder.sol');
const TestGovernorService = artifacts.require('./TestGovernorService.sol');
...
contract('TestGovernorService', async accounts => {
  ...
  beforeEach(async () => {
    regulator = await TestGovernorService.new({ from: owner });
